    ...
    <View className="flex-1 bg-gray-100">
      ...
      <View className="absolute bottom-5 w-full px-6">
        <View className=" flex flex-row justify-between gap-2">
          <TouchableOpacity className="bg-gray-200 px-8 flex-row justify-center items-center rounded-2xl">
            <ShoppingCartIcon size={25} color={'#000'} />
          </TouchableOpacity>
          <TouchableOpacity className="bg-yellow-400 flex-1 py-4 rounded-2xl">
